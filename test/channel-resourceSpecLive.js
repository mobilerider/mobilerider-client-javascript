// By default these tests are not executed, see the comment in the
// `test/test-main.js` file if you want to activate them

define(['utils', 'settings', 'client', 'resource', 'channel-resource'], function (Utils, Settings, Client, Resource, ChannelResource) {
    // sinonLog = sinon.log;
